        ...
        <form action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <form class="form-light">
                ...
                <div class="d-flex mt-3">
                    ...
                    <div class="col-6">
                        <x-layouts.dropdowns name="buyer_id" title="Buyer" id="buyer_id" :dropItems="$buyers"
                            :setItem="old('buyer')" option1="Select Buyer Name" />
                    </div>
                    <div class="col-6">
                        <x-layouts.input name="total_due" class="mt-2" title="Total Due" type="text" id="total_due"
                            :value="old('totalDue')" />
                    </div>
                </div>
