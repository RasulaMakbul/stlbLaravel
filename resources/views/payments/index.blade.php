            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-secondary"><i class="fa-solid fa-table"></i>
                        {{ __('Excel') }}</button>
                    <a type="button" href="{{ route('payment.trash') }}" class="btn btn-sm btn-outline-secondary"><i class="fa-solid fa-trash fs-5"></i> {{ __('Trash') }}</a>
            ...
            <table class="table table-dark table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('payment.edit', $payment->id) }}" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
